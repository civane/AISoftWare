...
public class RegressionTest0 {
    ...
    public void test3() throws Throwable {
        ...
        Solution solution0 = new Solution();
        int int2 = solution0.numberOfSpecialChars("hi!");
        int int4 = solution0.numberOfSpecialChars("");
        int int6 = solution0.numberOfSpecialChars("hi!");
    ...
    public void test5() throws Throwable {
        ...
        int int2 = solution0.numberOfSpecialChars("hi!");
        int int4 = solution0.numberOfSpecialChars("");
        int int6 = solution0.numberOfSpecialChars("");
